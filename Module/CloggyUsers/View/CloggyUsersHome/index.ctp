				    ...
				    <div class="btn-group">
						...
						<ul class="dropdown-menu">
							<li>
								...
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/index/sort_index:status_asc'); ?>
							</li>
							<li>
								<?php echo $this->Html->link('Status DESC',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/index/sort_index:status_desc'); ?>
							</li>
							<li class="divider"></li>
							<li>
								<?php echo $this->Html->link('Role ASC',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/index/sort_index:role_asc'); ?>
							</li>
							<li>
								<?php echo $this->Html->link('Role DESC',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/index/sort_index:role_desc'); ?>
							</li>
							<li class="divider"></li>
							<li>
								<?php echo $this->Html->link('Name ASC',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/index/sort_index:name_asc'); ?>
							</li>
							<li>
								<?php echo $this->Html->link('Name DESC',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/index/sort_index:name_desc'); ?>
							</li>
						</ul>
					</div>
			</td>
		...
		<?php if(!empty($users)) : ?>
			<?php foreach($users as $user) :?>
				<tr>
					...
					<td>
						<?php echo $this->Html->link($user['CloggyUser']['user_name'],
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/edit/'.$user['CloggyUser']['id']); ?>
					</td>
					...
					<td>
						...
						<?php echo $this->Html->link('Remove',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/remove/'.$user['CloggyUser']['id'],array('class' => 'users_remove')); ?>
								|
								
						<?php if($user['CloggyUser']['user_status'] > 0) :?>
						<?php echo $this->Html->link('Disable',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/disable/'.$user['CloggyUser']['id'],array('class' => 'users_disable')); ?>
						<?php else: ?>
						<?php echo $this->Html->link('Enable',
								'/'.Configure::read('Cloggy.url_prefix').'/module/cloggy_users/cloggy_users_home/enable/'.$user['CloggyUser']['id'],array('id' => 'users_enable')); ?>
						<?php endif; ?>
					</td>
				</tr>
			<?php endforeach; ?>
