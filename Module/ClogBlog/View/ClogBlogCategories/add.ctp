<?php echo $this->Form->create('ClogBlogCategories',array(
	'url' => '/'.Configure::read('Clog.url_prefix').'/module/clog_blog/clog_blog_categories/add',
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="data[ClogBlogCategories][category_parent]">
						...
						<option value="<?php echo $category['ClogNode']['id']; ?>"><?php echo $category['ClogSubject']['subject']; ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			</div>
