<?php echo $this->Form->create('ClogUser',array(
	'url' => '/'.Configure::read('Clog.url_prefix').'/module/users/users_home/edit/'.$id,
	'class' => 'form-horizontal'
)); ?>
	<fieldset>
		<legend>Edit '<?php echo $user['ClogUser']['user_name']; ?>'</legend>				
		...
		<div class="control-group <?php if(isset($errors['user_email'])) : echo  'error'; endif; ?>">
			...
			<div class="controls">
				<?php echo $this->Form->input('user_email',array(
						...
						'type' => 'email',
						'value' => $user['ClogUser']['user_email'],
						'div' => false)
				); ?>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="radio inline">
					<input type="radio" name="data[ClogUser][user_status]" value="1" <?php if($user['ClogUser']['user_status']=='1') echo 'checked="checked"'?>> Yes
				</label>
				<label class="radio inline">					
					<input type="radio" name="data[ClogUser][user_status]" value="0" <?php if($user['ClogUser']['user_status']=='0') echo 'checked="checked"'?>> No
				</label>
			</div>
		</div>
		<div class="control-group">
