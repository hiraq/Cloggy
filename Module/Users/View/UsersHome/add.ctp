<?php echo $this->Form->create('ClogUser',array(
	'url' => '/'.Configure::read('Clog.url_prefix').'/module/users/users_home/add',
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="radio inline">
					<input type="radio" name="data[ClogUser][user_status]" value="1"> Yes
				</label>
				<label class="radio inline">
					<input type="radio" name="data[ClogUser][user_status]" value="0"> No
				</label>
			</div>
		</div>
		<div class="control-group">
