...
class CloggyBlogTagsController extends CloggyAppController {
	...
	public function beforeFilter() {
		...
		$this->CloggyModuleMenu->add('cloggy_blog',array(
			'Add New Tag' => $this->_base.'/module/cloggy_blog/cloggy_blog_tags/add',
			'Manage Tags' => $this->_base.'/module/cloggy_blog/cloggy_blog_tags',
	...
	public function add() {
		...
		if($this->request->is('post')) {
			...
			$checkTagExists = $this->CloggyBlogTag->isTagExists(
					$this->request->data['CloggyBlogTags']['tag_name'],
					$this->_user['id']);
