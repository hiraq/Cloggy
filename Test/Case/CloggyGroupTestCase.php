...
/**
 * @link https://github.com/cakephp/debug_kit/blob/master/Test/Case/DebugkitGroupTestCase.php follow DebugKit group test
 */
class CloggyGroupTestCase extends PHPUnit_Framework_TestSuite {
	...
	public static function getTestFiles($directory = null, $excludes = null) {
		...
		if ($directory === null || $directory !== realpath($directory)) {
			$basePath = App::pluginPath('Cloggy') . 'Test' . DS . 'Case' . DS;
